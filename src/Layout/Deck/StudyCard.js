...
export default function StudyCard({ cards }) {
  ...
  // if more than 2 cards, display card front with flip and then next button once flipped
  if (cards.length > 2) {
    return (
      <div>
    ...
    // tells user to add more cards if less than 3
    return (
      <div>
        <h2>Not enough cards</h2>
        <p>
          You need at least 3 cards to study. Current card count: {cards.length}.
        </p>
